...
namespace OTComm
{
	namespace Muovi
	{
		...
		public ref class AdapterMuovi : public GenericAdapter
		{
		public:
			AdapterMuovi() {}
			///<summary>Description of adapter</summary>
			///<returns>description of adapter</returns>
			property String^ Description { String^ get() override { return "AdapterMuovi"; }}
			///<summary>ID of adapter</summary>
			///<returns>ID of adapter</returns>
			property String^ ID { String^ get() override { return "AdapterMuovi"; }}
			///<summary>Image of adapter</summary>
			///<returns>Image of adapter</returns>
