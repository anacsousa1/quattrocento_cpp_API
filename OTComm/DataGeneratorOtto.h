...
namespace OTComm {
	namespace Otto
	{
		...
		{
		public:
			static const Frequency Otto_1000Hz = 1000;
		};
		...
		{
		public:
			static const Model OttoStandard = 8;
			static const Model QuattroStandard = 4;
		};

		///<summary>DataGenerator for Formeter</summary>
		public ref class DataGeneratorOtto : public DataGeneratorInterface
		{
		public:
			~DataGeneratorOtto();
			!DataGeneratorOtto();
			...
			DataGeneratorOtto(Model model, Frequency SamplingFrequency);
			...
			virtual void OpenDevice(String ^RemoteName);
			...
			void ConnectIn(AdapterOtto^ adapter);
			...
			static DataGeneratorOtto^ FromXMLConfiguration(String^ Filename);
		...
		private:
			static AdapterOtto^ GetAdapterFromID(String^ adapterID);
