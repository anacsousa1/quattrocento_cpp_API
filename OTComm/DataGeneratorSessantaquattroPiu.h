...
#include "Sensors.h"
#include "AdapterSessantaquattroPiu.h"
...
namespace OTComm {
	namespace SessantaquattroPiu {
		...
		{
		public:
			static const Frequency SessantaquattroPiu_500Hz = 500;
			static const Frequency SessantaquattroPiu_1000Hz = 1000;
			static const Frequency SessantaquattroPiu_2000Hz = 2000;
			static const Frequency SessantaquattroPiu_4000Hz = 4000;
		};
		...
		{
		public:
			static const Model SessantaquattroPiu_08 = 10008;
			static const Model SessantaquattroPiu_16 = 10016;
			static const Model SessantaquattroPiu_32 = 10032;
			static const Model SessantaquattroPiu_64 = 10064;
		};
		...
		public ref class DataGeneratorSessantaquattroPiu : public DataGeneratorInterface
		{
		public:
			event OTComm::OpenDevice^ OnOpenDevice;
			void FireOpenDevice() { OnOpenDevice(this, gcnew System::EventArgs()); }
			~DataGeneratorSessantaquattroPiu();
			!DataGeneratorSessantaquattroPiu();
			///<param name="model">Model of device</param>
			///<param name="SamplingFrequency">Sampling Frequency</param>
			DataGeneratorSessantaquattroPiu(Model model, Frequency SamplingFrequency, bool HighRes);
			...
			static DataGeneratorSessantaquattroPiu^ FromXMLConfiguration(String^ Filename);
			...
			///<summary>get number quaternion</summary>
			///<returns>number quaternion</returns>
			...
			///<summary>get number of quaternions channel</summary>
			///<returns>number quaternion</returns>
			unsigned int GetNumberChannelsQuaternion();
			...
			void ConnectIn(const unsigned int port, AdapterSessantaquattroPiu^ adapter);
			///<summary>Connect In to device</summary>
			///<param name="port">in connector to fill</param>
			///<param name="adapter">AdapterIn to connect</param>
		...
		protected:
			...
			Model mModel;
			void  OuternThread();
			void InternalStopSessantaquattroPiuDataTransfer(void);
