...
<member name="T:OTComm.Forza.AdapterAux" decl="false" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\adapterforza.h" line="7">
<summary>Adapter for Forza</summary>
</member>
<member name="P:OTComm.Forza.AdapterAux.Description" decl="false" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\adapterforza.h" line="12">
<summary>Description of adapter</summary>
<returns>description of adapter</returns>
</member>
<member name="P:OTComm.Forza.AdapterAux.ID" decl="false" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\adapterforza.h" line="15">
<summary>ID of adapter</summary>
<returns>ID of adapter</returns>
</member>
<member name="P:OTComm.Forza.AdapterAux.Image" decl="false" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\adapterforza.h" line="18">
<summary>Image of adapter</summary>
<returns>Image of adapter</returns>
</member>
<member name="P:OTComm.Forza.AdapterAux.MaxNumChannels" decl="false" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\adapterforza.h" line="21">
<summary>max number of channel available for adapter</summary>
<returns>max number of channel available for adapter</returns>
</member>
<member name="P:OTComm.Forza.AdapterAux.MinSizeSensor" decl="false" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\adapterforza.h" line="24">
<summary>min size sensor available for adapter</summary>
<returns>min size sensor available for adapter</returns>
</member>
<member name="P:OTComm.Forza.AdapterAux.MaxSizeSensor" decl="false" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\adapterforza.h" line="27">
<summary>max size sensor available for adapter</summary>
<returns>max size sensor available for adapter</returns>
</member>
<member name="P:OTComm.Forza.AdapterAux.AdapterGain" decl="false" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\adapterforza.h" line="30">
<summary>gain of adapter</summary>
<returns>gain of adapter</returns>
</member>
<member name="T:OTComm.Forza.SerialBaudRates" decl="false" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\datageneratorforza.h" line="15">
<summary>Baudrates available</summary>
</member>
<member name="T:OTComm.Forza.Frequencies" decl="false" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\datageneratorforza.h" line="26">
<summary>Frequencies available</summary>
</member>
<member name="T:OTComm.Forza.DataGeneratorForza" decl="false" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\datageneratorforza.h" line="34">
<summary>DataGenerator for Forza</summary>
</member>
<member name="M:OTComm.Forza.DataGeneratorForza.#ctor(System.String,System.UInt32!System.Runtime.CompilerServices.IsLong)" decl="true" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\datageneratorforza.h" line="40">
<summary>
...
<member name="M:OTComm.Forza.DataGeneratorForza.GetDeviceDescription" decl="true" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\datageneratorforza.h" line="46">
<summary>
Get device description
</summary>
<returns>Returns description of the device</returns>
</member>
<member name="M:OTComm.Forza.DataGeneratorForza.GetDeviceXMLConfiguration" decl="true" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\datageneratorforza.h" line="51">
<summary>
Get device xml configuration
</summary>
<returns>Returns xml of the device configuration</returns>
</member>
<member name="M:OTComm.Forza.DataGeneratorForza.GetSavingXMLConfiguration" decl="true" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\datageneratorforza.h" line="56">
<summary>Get saving xml of device</summary>
<returns>saving xml of device</returns>
</member>
<member name="M:OTComm.Forza.DataGeneratorForza.OpenDevice" decl="true" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\datageneratorforza.h" line="59">
<summary>
Open the device communication
</summary>
</member>
<member name="M:OTComm.Forza.DataGeneratorForza.InitializeDevice" decl="true" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\datageneratorforza.h" line="63">
<summary>
Initialize the device
</summary>
</member>
<member name="M:OTComm.Forza.DataGeneratorForza.StartAcquisition" decl="true" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\datageneratorforza.h" line="67">
<summary>
Starts the acquisition of data from the device
</summary>
</member>
<member name="M:OTComm.Forza.DataGeneratorForza.StopAcquisition" decl="true" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\datageneratorforza.h" line="71">
<summary>
Stops the acquisition of data from the device
</summary>
</member>
<member name="M:OTComm.Forza.DataGeneratorForza.CloseDevice" decl="true" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\datageneratorforza.h" line="75">
<summary>
Close the device communication
</summary>
</member>
<member name="M:OTComm.Forza.DataGeneratorForza.ConnectIn(OTComm.Forza.AdapterAux)" decl="true" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\datageneratorforza.h" line="79">
<summary>Connect In to device</summary>
<param name="adapter">AdapterForza to connect</param>
</member>
<member name="M:OTComm.Forza.DataGeneratorForza.GetNumberConnectorsIn" decl="true" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\datageneratorforza.h" line="82">
<summary>get number in connectors</summary>
<returns>number in connectors</returns>
</member>
<member name="P:OTComm.Forza.DataGeneratorForza.Image" decl="false" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\datageneratorforza.h" line="85">
<summary>Get image of device</summary>
<returns>image of device</returns>
</member>
<member name="M:OTComm.Forza.DataGeneratorForza.FromXMLConfiguration(System.String)" decl="true" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\datageneratorforza.h" line="88">
<summary>get DataGeneratorEMGUSB from xml</summary>
<param name="Filename">path to XML file</param>
<returns>DataGeneratorEMGUSB</returns>
</member>
<member name="M:OTComm.Forza.DataGeneratorForza.GetSensibility" decl="true" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\datageneratorforza.h" line="92">
<summary>Get sensibility of cell</summary>
<returns>sensibility of cell</returns>
</member>
<member name="M:OTComm.Forza.DataGeneratorForza.SetSensibility(System.Double)" decl="true" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\datageneratorforza.h" line="95">
<summary>Set sensibility of cell</summary>
<param name="sensibility">sensibility</param>
</member>
<member name="M:OTComm.Forza.DataGeneratorForza.GetMaximumLoad" decl="true" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\datageneratorforza.h" line="98">
<summary>Get maxmimum load of cell</summary>
<returns>maxmimum load of cell</returns>
</member>
<member name="M:OTComm.Forza.DataGeneratorForza.SetMaximumLoad(System.Double)" decl="true" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\datageneratorforza.h" line="101">
<summary>Set maxmimum load of cell</summary>
<param name="maximumLoad">maximumLoad</param>
</member>
<member name="M:OTComm.Forza.DataGeneratorForza.GetComPort" decl="true" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\datageneratorforza.h" line="104">
