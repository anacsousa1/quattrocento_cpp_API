...
<member name="T:OTComm.Test.AdapterTest" decl="false" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\adaptertest.h" line="7">
<summary>Adapter for Test</summary>
</member>
<member name="P:OTComm.Test.AdapterTest.Description" decl="false" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\adaptertest.h" line="12">
<summary>Description of adapter</summary>
<returns>description of adapter</returns>
</member>
<member name="P:OTComm.Test.AdapterTest.ID" decl="false" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\adaptertest.h" line="15">
<summary>ID of adapter</summary>
<returns>ID of adapter</returns>
</member>
<member name="P:OTComm.Test.AdapterTest.MaxNumChannels" decl="false" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\adaptertest.h" line="18">
<summary>max number of channel available for adapter</summary>
<returns>max number of channel available for adapter</returns>
</member>
<member name="P:OTComm.Test.AdapterTest.MinSizeSensor" decl="false" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\adaptertest.h" line="21">
<summary>min size sensor available for adapter</summary>
<returns>min size sensor available for adapter</returns>
</member>
<member name="P:OTComm.Test.AdapterTest.MaxSizeSensor" decl="false" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\adaptertest.h" line="24">
<summary>max size sensor available for adapter</summary>
<returns>max size sensor available for adapter</returns>
</member>
<member name="P:OTComm.Test.AdapterTest.AdapterGain" decl="false" source="c:\lavoro\git\__customerservice__\ot biolab+\otcomm\adaptertest.h" line="27">
