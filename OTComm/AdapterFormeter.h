...
namespace OTComm
{
	namespace Formeter
	{
		...
		public ref class AdapterFormeter abstract : public GenericAdapter {};
		///<summary>Adapter AD8x1TR</summary>
		public ref class AdapterStandard : public AdapterFormeter
		{
		public:
			AdapterStandard() {}
			///<summary>Description of adapter</summary>
			///<returns>description of adapter</returns>
			property String^ Description { String^ get() override { return "Standard Formeter Adapter"; }}
			///<summary>ID of adapter</summary>
			///<returns>ID of adapter</returns>
			property String^ ID { String^ get() override { return "Standard"; }}
			///<summary>Image of adapter</summary>
			///<returns>Image of adapter</returns>
			property Bitmap^ Image { Bitmap^ get() override { return Utilities::GetImageFromEmbeddedResource("StandardFormeterAdapter.png", true); }}
